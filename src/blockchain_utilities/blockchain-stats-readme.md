# LibertyChain Blockchain Stats

LibertyChain Blockchain Stats utlity exports daily statistics for the LibertyChain blockchain from creation through current state.

## Usage:

See also the utility's help option. `LibertyChain-blockchain-stats --help`
...
i.e. `LibertyChain-blockchain-stats > stats.csv` 
