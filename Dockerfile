...
# Create LibertyChain user
RUN adduser --system --group --disabled-password LibertyChain && \
	mkdir -p /wallet /home/LibertyChain/.bitLibertyChain && \
	chown -R LibertyChain:LibertyChain /home/LibertyChain/.bitLibertyChain && \
	chown -R LibertyChain:LibertyChain /wallet

# Contains the blockchain
VOLUME /home/LibertyChain/.bitLibertyChain

# Generate your wallet via accessing the container and run:
# cd /wallet
# LibertyChain-wallet-cli
VOLUME /wallet

EXPOSE 18080
EXPOSE 18081

# switch to user LibertyChain
USER LibertyChain

ENTRYPOINT ["LibertyChaind", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"]
